...
#define SPECIAL_KEY_POLARITY -1 // -1 AUTO, 0 = NO, 1 = NC

#define SPECIAL_KEY_POLARITY_SWITCH_PIN PIN_A3
#define SPECIAL_KEY_MODE_SWITCH_PIN PIN_A2
...
#define SPECIAL_KEY_ALT KEY_ESC
